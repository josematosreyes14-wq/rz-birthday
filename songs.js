const songs = [
    ...
    },
    {
        ...
        "message": "Tú, amor, y yo, y si solamente tu y yo, ¿Qué nos importa a tí, o a mí? (deberías leerte ese poema, casi tan bueno como las 'mandarinas', pero no tanto como tú)",
        "videoId": "Z0TgxTlwiVw",
        "duration": "3:21",
        "videoTitle": "Damiano David - Tangerine (Sub. Español + Lyrics)",
        "channel": "sweetblue.",
        "scene": "sunset",
        theme: {
            background: "#120E16",
    ...
    },
    {
        ...
        "message": "Di tanto in tanto, quando vedo il tuo viso, vorrei che tu fossi il mio 'per sempre' e il mio *ramé*.",
        "videoId": "1w7OgIMMRc4",
        "duration": "5:03",
